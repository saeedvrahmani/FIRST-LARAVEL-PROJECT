    ...
    <div class="col-xl-12 col-md-12 mb-4 p-md-5 bg-white">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="attribute_Is_Filter_ids">ویژگی های قابل فیلتر</label>
                    <select id="attributeIsFilterSelect" class="form-control" name="attribute_Is_Filter_ids[]" multiple
                        data-live-search="true">

                    </select>
                </div>
                <div class="form-group col-md-3">
                    <label for="variation_id">انتخاب ویژگی های متغیر</label>

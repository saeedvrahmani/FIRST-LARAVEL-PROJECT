                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="custom-file">
                            <input type="file" name="primary_image" class="custom-file-input" id="primary_image" value="{{old('primary_image')}}">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="custom-file">
                            <input type="file" name="images[]" multiple class="custom-file-input" id="images" value="{{old('images[]')}}">
                            ...
                            <div id="first">
                                <div class="recordset">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label>نام</label>
                                            <input class="form-control" name="variation_values[value][]" type="text" value="{{old('variation_values[value][]')}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>قیمت</label>
                                            <input class="form-control" name="variation_values[price][]" type="text" value="{{old('variation_values[price][]')}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>تعداد</label>
                                            <input class="form-control" name="variation_values[quantity][]" type="text" value="{{old('variation_values[quantity][]')}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>شناسه انبار</label>
                                            <input class="form-control" name="variation_values[sku][]" type="text" value="{{old('variation_values[sku][]')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>

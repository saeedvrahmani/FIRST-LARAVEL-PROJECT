                        ...
                        <div class="tab-content description-review-bottom">
                            ...
                            <div id="des-details2" class="tab-pane {{ count($errors) > 0 ? 'active' : '' }}">
                                            ...
                                            <div class="review-content w-100 text-right">
                                                ...
                                                <div class="review-top-wrap">
                                                    <div class="review-name">
                                                        <h4> {{ $comment->user->name == null ? 'کاربر ناشناس' : $comment->user->name }}
                                                        </h4>
                                                    </div>
                                                    <div  id="dataReadonlyReview" data-rating-stars="5"
                                                        data-rating-value="{{ceil($comment->user->rates->where('product_id' , $product->id)->avg('rate'))}}" data-rating-input="#rateInput">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="ratting-form-wrapper text-right">
                                    ...
                                    <div id="dataReadonlyReview" data-rating-stars="5" data-rating-value="{{ceil($product->rates->avg('rate')) }}"
                    ...
                    <div class="ht-product ht-product-action-on-hover ht-product-category-right-bottom mb-30">
                        <div class="ht-product-inner">
                            ...
                            @endauth
                                        ...
                                        <li>
                                            <a href="{{route('home.cart.add')}}"><i class="sli sli-bag"></i><span
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12" style="direction: rtl;">
                            <div class="product-details-content  quickview-content">
                                ...
                                <div class="pro-details-quality">
                                    ...
                                    <div class="pro-details-cart">
                                        <a href="{{route('home.cart.add')}}">افزودن به سبد خرید</a>
                                    </div>
                                    <div class="pro-details-wishlist">
                                  @auth
